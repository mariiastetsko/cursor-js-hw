...
const sumWithoutCoins = Math.trunc(Math.floor(pear) + Math.floor(pineapple) + Math.floor(mango));
...
const htmlOutput = document.getElementById('barvaToHtml');
...
<p>Is the sum even or odd: ${isEven('Number is even!')}</p>
